...
visualize several types of phylogentic networks using the ggplot2
\cite{Wickham2016} syntax. More specific \Biocpkg{ggnetworx} contains function
...
\cite{Bryant2004}. This can be either done using the consensusNet or neighbor net function in \CRANpkg{phangorn}\cite{Schliep2011} or by importing from SplitsTree \cite{Huson2006}
